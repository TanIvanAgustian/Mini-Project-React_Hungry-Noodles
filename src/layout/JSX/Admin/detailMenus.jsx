...
export default function DetailMenus() {
    ...
    return (
        ...
        <div className="row">
            {item?.map((post) => (
            <div
                className="col-10 rounded mx-auto mt-3 mb-3 bg-light p-3"
                key={post.id}
            >
                <div className="row">
                ...
                <div className="col-5 mt-5">
                    ...
                    <span className="mb-3 fs-6 badge rounded-pill bg-primary">
                        Tersedia
                    </span>
                    ) : (
                    <span className="mb-3 fs-6 badge rounded-pill bg-danger">
                        Kosong
                    </span>
                    )}
                    <div className="row text-center">
                    <button
                        className="col me-3 btn btn-primary rounded-pill"
                        onClick={() => setModalShow(true)}
                    >
                        Edit
                    </button>
                    <button
                        className="col me-4 btn btn-danger rounded-pill"
