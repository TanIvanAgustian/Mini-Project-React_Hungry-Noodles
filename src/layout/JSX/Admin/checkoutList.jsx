        ...
        if (post.cancelation == false && post.confirmation == false){
            item.push(
                <div className="col-5 ms-3 mt-3 d-flex">
                    <button className="btn btn-danger w-100 me-2" onClick={() => handleCancel(post.id)}><FontAwesomeIcon icon={["fas","xmark"]} fixedWidth/>Tolak</button>
                    <button className="btn btn-success w-100" onClick={() => handelConfirm(post.id)}><FontAwesomeIcon icon={["fas","check"]} fixedWidth/>Terima</button>
                </div>
            )
        }
        else if (post.cancelation == true) {
            item.push(
                <span className="badge bg-danger rounded-3 p-2 mt-3" class="badge bg-danger"><FontAwesomeIcon icon={["fas","xmark"]} fixedWidth/>Ditolak</span>
            )
        }
        else if (post.confirmation == true) {
            item.push(
                <span className="badge bg-success rounded-3 p-2 mt-3" class="badge bg-success"><FontAwesomeIcon icon={["fas","check"]} fixedWidth/>Confirmed</span>
            )
        }
        return item
    }
                    ...
                    >
                        ...
                        <div class="event-img d-flex justify-content-between">
                            ...
                            <div className="row">
                                ...
                                <div className="col">
                                <h6 className="my-0 ms-3">: {post.phoneNumber}</h6>
                                </div>
                            </div>
                            </div>
                        </div>
                    ...
                    <div className="row">
                        ...
                        <div className="col mt-3">
                            ...
                            <div className="row">
                                ...
                                <div className="col">
                                <h6 className="my-0 ms-3">: RP.{post.totalPayment}</h6>
                                </div>
                            </div>
                            <div className="row">
                                {handleAction(post)}
