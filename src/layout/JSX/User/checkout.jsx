...
export default function Checkout() {
  ...
  const handleProvinsi = (e) => {
    ...
    const cityList = City.filter(
      (element) => element.province == getProvinceName
    );
    setCity(cityList);
  };
  ...
  const handleKota = (e) => {
    ...
    const postalCode = City.filter(
      (element) => element.city_name == getCityName
    );
  ...
  const formik = useFormik({
    ...
    validationSchema: Yup.object({
      phoneNumber: Yup.string()
        .required("Phone Number Empty")
        .matches("^[0-9]*$", "Contain Number Only"),
        ...
        <div className="row">
                ...
                >
                  <div>
                    ...
                    <small className="text-muted">
                      Price : {post.menuPrice}
                    </small>
                    <br />
                    <small className="text-muted">
                      Amount : {post.menuAmount}
                    </small>
                  </div>
          ...
          <div className="col-md-8 order-md-1">
            ...
            <form onSubmit={formik.handleSubmit}>
              ...
              <div className="row">
                <div className="col-md-5 mb-3">
                  ...
                  >
                    ...
                    {Province?.map((Provinsi, index) => (
                      <option value={Provinsi.province} key={index}>
                        {Provinsi.province}
                      </option>
                    ))}
                  </select>
                ...
                <div className="col-md-4 mb-3">
                  ...
                  >
                    <option value="">Choose...</option>
                    {city?.map((kota, index) => (
                      <option value={kota.city_name} key={index}>
                        {kota.city_name}
                      </option>
                    ))}
                  </select>
                ...
                <div className="col-md-3 mb-3">
                  ...
                  >
                    ...
                    {postalCode?.map((kode, index) => (
                      <option value={kode.postal_code} key={index}>
                        {kode.postal_code}
                      </option>
                    ))}
                  </select>
              ...
              <button
                className="btn btn-primary btn-lg btn-block p-3 mb-3"
                type="submit"
              >
                <FontAwesomeIcon icon={["fas", "cart-shopping"]} fixedWidth />{" "}
                Checkout
